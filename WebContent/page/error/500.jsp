...
<title>Codenator :: 접속이 원활하지 않습니다</title>
</head>
<style>
  h4, h5 {
...
<body>
  <div class="errorContainer" style="margin: 103px auto 0; width: 600px;">
    <div class="well" style="height: 600px; background-color: #fff;">
      ...
      <div class="errorBody">
        <h3 class="oops" style="text-align: center; color: #5d5d5d;"><b>이런! </b>접속이 불안정 합니다!</h3>
        ...
        <p class="desc_error">서비스 접속이 원활하지 않습니다.<br></p>
        <p class="desc_error">관리자에게 문의해주세요.</p>
      </div>
