...
<div class="col-sm-2 sidenav">
  <div class="well" style="padding: 5px 5px 5px 5px; margin-bottom: 5px;">
    <div class="media">
      ...
      class="btn btn-warning btn-lg btn-block" style="font-size: 70%;">정보 수정하기</a>
      <a href="${pageContext.request.contextPath}/page/menu/prof/prof_create.jsp?prof_id=<%=mdto2.getProf_id()%>" 
  ...
  <div class="dropdown">
    ...
    <ul class="dropdown-menu" style="width: 100%;">
      ...
      <%--         <%
        ...
        %> --%>
      <li><a href="${pageContext.request.contextPath}/page/menu/prof/prof_subject_brief.jsp?inverse=true&prof_id=<%=cdto.getProf_id()%>&cid=<%=cdto.getCid()%>"><%=cdto.getCname() %></a></li>
      <%
          }
        %>
