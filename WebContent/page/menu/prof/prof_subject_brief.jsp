  ...
  app.controller('ctrl', function($scope, $http, $interval, $timeout) {
  	$scope.load = function(){
  		$http({
  			...
  			$scope.question = $scope.data[1].question;
...
<body ng-controller="ctrl">
  ...
  <div class="container-fluid text-center">
    <div class="row content" style="min-height:800px; height:80%">
      ...
      <div class="col-sm-8 text-left" style="margin-bottom: 20px; margin-top: 20px">
        <div class="row">
          <div class="col-sm-3">
          ...
          <div class="container" style="border: 1px solid #e5e5e5; border-radius: 6px; /* background: #fff; */ width: inherit; padding: 12px; margin: 10px">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td >
                    ...
                    <a href="${pageContext.request.contextPath}/page/menu/prof/prof_notice_remove.jsp?prof_id=<%=ndto.getProf_id()%>&no=<%=ndto.getNo()%>&cid=<%=ndto.getCid() %>" 
            ...
            <!-- Important! Float! -->
            <a href="prof_notice.jsp?subject=<%=cdto2.getCname() %>&cid=<%=cdto2.getCid()%>&prof_id=<%=cdto2.getProf_id()%>" class="btn btn-default" style="float: right;">작성하기</a>
          </div>
          <!-- Third Container -->
          <div class="container" style="border: 1px solid #e5e5e5; border-radius: 6px; /* background: #fff; */ width: inherit; padding: 12px; margin: 10px">
            ...
            %>
                <tr>
                  ...
                  <td>
                    <!-- It should ask user whether remove or not; Have to fix it -->
                    <a href="${pageContext.request.contextPath}/page/menu/prof/prof_assign_remove.jsp?prof_id=<%=adto.getProf_id()%>&no=<%=adto.getNo()%>&cid=<%=adto.getCid() %>" onclick="window.open(this.href, '', ''); return false;"> <span class="glyphicon glyphicon-remove" style="margin-top: 3px"></span>
                    </a>
                  </td>
                </tr>
                <%
            ...
            <tr>
                  ...
                  <td >
                    <!-- It should ask user whether remove or not; Have to fix it -->
                    <a href="${pageContext.request.contextPath}/page/menu/prof/prof_assign_remove.jsp?prof_id=<%=adto.getProf_id()%>&no=<%=adto.getNo()%>&cid=<%=adto.getCid() %>" 
                    onclick="window.open(this.href, '', ''); return false;">
                    <span class="glyphicon glyphicon-remove" style="margin-top:3px"></span>
                    </a>
                  </td>
            ...
            <!-- Important! Float! -->
            <a href="prof_assign_simple.jsp?cname=<%=cdto2.getCname() %>&cid=<%=cdto2.getCid()%>&prof_id=<%=cdto2.getProf_id()%>" class="btn btn-default" style="float: right;">출제하기</a>
